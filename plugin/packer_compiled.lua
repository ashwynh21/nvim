...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-autotag", "playground", "nvim-treesitter-refactor", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'git-messenger.vim', 'hop.nvim', 'null-ls.nvim', 'indent-blankline.nvim', 'nvim-lspconfig', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
