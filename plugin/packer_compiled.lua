...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-ts-autotag", "nvim-treesitter-refactor", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "C:\\Users\\ashwy\\AppData\\Local\\nvim-data\\site\\pack\\packer\\opt\\nvim-treesitter",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'git-messenger.vim', 'null-ls.nvim', 'gitsigns.nvim', 'hop.nvim', 'nvim-lspconfig'}, { event = "BufRead *" }, _G.packer_plugins)]]
