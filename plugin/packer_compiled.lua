...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'gitsigns.nvim', 'null-ls.nvim', 'git-messenger.vim', 'nvim-lspconfig', 'hop.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
