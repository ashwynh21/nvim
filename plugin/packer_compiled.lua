...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'null-ls.nvim', 'git-messenger.vim', 'gitsigns.nvim', 'nvim-lspconfig', 'hop.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
