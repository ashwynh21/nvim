...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'git-messenger.vim', 'sonarlint.nvim', 'gitsigns.nvim', 'hop.nvim', 'indent-blankline.nvim', 'null-ls.nvim', 'nvim-lspconfig'}, { event = "BufRead *" }, _G.packer_plugins)]]
