...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-autotag", "nvim-treesitter-refactor", "nvim-treesitter-textobjects", "playground", "nvim-ts-context-commentstring" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "C:\\Users\\ashwy\\AppData\\Local\\nvim-data\\site\\pack\\packer\\opt\\nvim-treesitter",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'git-messenger.vim', 'nvim-lspconfig', 'gitsigns.nvim', 'null-ls.nvim', 'hop.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
