...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-refactor", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "nvim-ts-autotag", "playground" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'git-messenger.vim', 'nvim-lspconfig', 'gitsigns.nvim', 'hop.nvim', 'null-ls.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
